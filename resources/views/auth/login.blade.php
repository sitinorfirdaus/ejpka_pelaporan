												...
												<div class="main-signup-header">
													...
													<form method="POST" action="{{ route('login') }}">
														...
														<div class="form-group">
															<label>Emel</label>
                                                            <input id="email" type="email" placeholder="masukkan emel rasmi kerajaan" class="form-control is-invalid @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus>
														...
														<div class="form-group">
															...
															<input id="password" type="password" placeholder="masukkan kata laluan" class="form-control @error('password') is-invalid @enderror" name="password" required autocomplete="current-password">
															@error('password')
																<span class="invalid-feedback" role="alert">
																	<strong>{{ $message }}</strong>
																</span>
														...
														<button class="btn btn-main-primary btn-block" type="submit">Log Masuk</button>
													</form>
