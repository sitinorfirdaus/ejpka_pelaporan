...
{{-- <div class="row row-sm"> --}}
	<div class="col-xl-14">
		<div class="card">
			<div class="card-body"><h2>LAPORAN MENGURUS</h2>
                        ...
                        <form id="addUserForm#" name="addUserForm#" method="GET" enctype="multipart/form-data" action="">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                       <input class="form-control" type="date" data-parsley-class-handler="#fnWrapper"  name="input1" id="input1" disabled/>
                                    </div>
                                    </div>
                    ...
                    <div class="form-group">
                        <div class="row">
                             <div class="col-md-3">
                                ...
                                <div class="col-md-3">
                                   <textarea class="form-control" row="5" col="10" data-parsley-class-handler="#fnWrapper"  name="melebihi_penjelasan" id="melebihi_penjelasan">{{$mengurus->melebihi_penjelasan}}</textarea>
                                </div>
                         </div>
                     </div>
                     ...
                     <div class="form-group ">
                         <div class="row">
                             <div class="col-md-3">
                                 <label class="form-label">Tindakan Penyelesaian<span class="tx-danger">*</span></label>
                             </div>
                                 <div class="col-md-3">
                                    <textarea class="form-control" row="5" col="10"  data-parsley-class-handler="#fnWrapper"  name="melebihi_tindakan" id="melebihi_tindakan" >{{$mengurus->melebihi_tindakan}}</textarea>
                                 </div>
                         </div>
                     </div>
                    ...
                    <form id="addUserForm" name="addUserForm" method="POST" enctype="multipart/form-data">
                        <input type="hidden" name="id" id="id">  <!--pull row id data -->
                                     ...
                                     <div class="form-group">
                                         <div class="row">
                                             <div class="col-md-12">
                                                 <label class="form-label">ii) Perbelanjaan kurang 95% atau melebihi 100% daripada peruntukan di akhir tahun (Berakhir 31 Disember sahaja):RM X </label>
                                             </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                             <div class="col-md-3">
                                                ...
                                                <div class="col-md-3">
                                                   <textarea class="form-control" row="5" col="10" data-parsley-class-handler="#fnWrapper"  name="kurang_penjelasan" id="kurang_penjelasan"></textarea>
                                                </div>
                                         </div>
                                     </div>
                                     ...
                                     <div class="form-group ">
                                         <div class="row">
                                             <div class="col-md-3">
                                                 ...
                                                 <div class="col-md-3">
                                                    <textarea class="form-control" row="5" col="10"  data-parsley-class-handler="#fnWrapper"  name="kurang_tindakan" id="kurang_tindakan" ></textarea>
                                                 </div>
                                         </div>
                                     </div>
